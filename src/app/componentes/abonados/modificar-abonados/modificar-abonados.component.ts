...
export class ModificarAbonadosComponent implements OnInit {
   ...
   constructor(public fb: FormBuilder, private abonadosS: AbonadosService,
   ...
   retornar() { this.router.navigate(['detalles-abonado']);   }
   ...
   compararRutas(o1: Rutas, o2: Rutas): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idruta == o2.idruta;
      }
   }
   ...
   compararUbicacion(o1: Ubicacionm, o2: Ubicacionm): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idubicacionm == o2.idubicacionm;
      }
   }
   ...
   compararTpPago(o1: Tipopago, o2: Tipopago): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idtipopago == o2.idtipopago;
      }
   }
   ...
   compararEstadoM(o1: Estadom, o2: Estadom): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idestadom == o2.idestadom;
      }
   }

   mensajeSuccess(n: String) {
      localStorage.setItem("mensajeSuccess", "Abonado <strong>" + n + "</strong> actualizado");
   }
