...
export class AddAbonadosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    estadom.idestadom = 1;
    setTimeout(() => {
      let o_categorias = document.getElementById(
        'id-c' + categoria.idcategoria
      ) as HTMLElement;
      let o_rutas = document.getElementById(
        'id-r' + rutas.idruta
      ) as HTMLElement;
      let o_ubicacionm = document.getElementById(
        'id-um' + ubicacionm.idubicacionm
      ) as HTMLElement;
      let o_tipopago = document.getElementById(
        'id-tp' + tipopago.idtipopago
      ) as HTMLElement;
      let o_estadom = document.getElementById(
        'id-em' + estadom.idestadom
      ) as HTMLElement;
  ...
  guardarAbonado(): void {
    ...
    this.aboService.saveAbonado(this.abonadoForm.value).subscribe(
      (datos) => {
  ...
  buscarCliente() {
    ...
    if (i_cliente.value === '') {
      ...
      i_cliente.style.border = '';
      this.clienteS
        .getByIdentificacion(this.f_clientes.value.buscarCliente)
        .subscribe((datos) => {
  ...
  buscarResponsablePago() {
    ...
    if (i_buscarResponsablePago.value === '') {
      ...
      this.clienteS
        .getByIdentificacion(this.f_responsablePago.value.buscarResponsablePago)
        .subscribe((datos) => {
