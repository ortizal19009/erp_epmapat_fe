...
export class ModificarReclamosComponent implements OnInit {
  ...
  constructor(public fb: FormBuilder, public router: Router, 
    public reclamosS:ReclamosService, public tpreclamoS: 
    TpReclamoService, public modulosS: ModulosService) { }
  ...
  compararTpReclamo(o1:TpReclamo , o2:TpReclamo):boolean{
    if(o1 === undefined && o2 === undefined){return true;}
      ...
      return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false: o1.idtpreclamo == o2.idtpreclamo;
    }
  }
  ...
  mensajeSuccess(n:String){
    localStorage.setItem("mensajeSuccess","Reclamos <strong>"+n+"</strong> actualizado");
  }
