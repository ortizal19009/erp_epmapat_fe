...
export class ModiUsoitemsComponent implements OnInit {
   ...
   constructor(public fb: FormBuilder, private router: Router, private moduService: ModulosService,
   ...
   ngOnInit(): void {
      ...
      const selectmodulo = document.getElementById("selectModulo") as HTMLSelectElement;
   ...
   retornar() { this.router.navigate(['/info-usoitems']); }
   ...
   valNombre(control: AbstractControl) {
      return this.usoService.getByNombre(this.idusoitems, control.value)
         .pipe(
