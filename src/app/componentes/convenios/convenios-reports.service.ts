...
export class ConveniosReportsService {
  ...
  impContratoConvenio(datos: any, cuotas: any) {
    ...
    let p3 = `1.- El deudor posee una deuda por Titulo(s) de AGUA Y ALCANTARILLADO a nombre de la ${empresa}, de referencia Nro.: ${datos.referencia}. El deudor por el momento no cuentga con los recursos económicos necesarios para cancelar los valores adeudados.`;
    let p4 = `2.- Mediante autorización de fecha 26-01-2024, el (la) ${administradores[0].nombre} ${administradores[0].cargo} autoriza se realice el correspondiente convenio de pago en un plazo de 365 días.`;
    ...
    let p9 = `Siendo un total de ${datos.totalconvenio}, a partir de la fecha de suscripción de este convenio hasta su termicación en el lapso de 365 diás, 12 meses, más la carta marcada en el transcurso del año.`;
