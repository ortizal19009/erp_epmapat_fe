...
export class InfoCajaComponent implements OnInit {
   ...
   constructor(private router: Router, private fb: FormBuilder, private cajaService: CajaService, private recxcaja: RecaudaxcajaService, private _pdf: PdfService, private s_facturas: FacturaService) { }
   ...
   pdf() {
      ...
      autoTable(doc, {
         head: [['Nro Factura', 'Nombre y Apellido', 'Módulo', 'Valor', 'Fecha cobro', 'Hora cobro', 'Usuario']],
         theme: 'grid',
