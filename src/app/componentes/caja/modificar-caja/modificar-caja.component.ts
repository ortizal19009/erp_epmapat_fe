...
export class ModificarCajaComponent implements OnInit {
   ...
   constructor(public fb: FormBuilder, private cajaService: CajaService, private router: Router,
   ...
   onSubmit() {
      this.cajaService.updateCaja(this.cajaForm.value).subscribe(datos => {
   ...
   retornar() { this.router.navigate(['info-caja']) }
   ...
   compararPtoEmision(o1: Ptoemision, o2: Ptoemision): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idptoemision == o2.idptoemision;
      }
   }
