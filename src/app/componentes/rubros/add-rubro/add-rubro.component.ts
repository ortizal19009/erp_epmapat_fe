...
export class AddRubroComponent implements OnInit {
   ...
   constructor(private fb: FormBuilder, private rubService: RubrosService,
      private moduService: ModulosService, private parent: RubrosComponent) { }
   ...
   crearForm() {
      ...
      this.formRubro = this.fb.group({
         ...
         descripcion: [null, [Validators.required, Validators.minLength(3), Validators.maxLength(100)], this.valNombre.bind(this)],
         estado: 1,
         valor: 0,
         calculable: 0,
         swiva: 0,
   ...
   valNombre(control: AbstractControl) {
      return this.rubService.getByNombre(this.idmodulo, control.value)
         .pipe(
