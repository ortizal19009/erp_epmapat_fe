...
export class ModiEjecucionComponent implements OnInit {
  ...
  disabled = true;
  antcodpar: String;
  idejecu: number; //Id del ejecucio que se modifica
  _gruposbene: any;
  ...
  ngOnInit(): void {
    ...
    this.ejecucioForm = this.fb.group({
  ...
  datosEjecucion() {
    ...
    this.ejecuService.getById(this.idejecu).subscribe({
      next: datos => {
        this.antcodpar = datos.codpar;
        this.ejecucioForm.setValue({
          codpar: datos.codpar,
  ...
  get codpar() { return this.ejecucioForm.get('codpar'); }
 ...
 //   location.reload(); // Agregar esta línea para refrescar la página
  ...
  selecPresupue(presupue: Presupue) {
    this.ejecucioForm.controls['nompar'].setValue(presupue.nompar);
    this.ejecucioForm.controls['codpar'].setValue(presupue.codpar);
    this.ejecucioForm.controls['intpre'].setValue(presupue);

  }

  valCodpar(control: AbstractControl) {
    return this.ejecuService.getByIdrefo(control.value)
      .pipe(
  ...
  compararPresupue(o1: Presupue, o2: Presupue): boolean {
    if (o1 === undefined && o2 === undefined) { return true; }
      ...
      return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.intpre == o2.intpre;
    }
  }
