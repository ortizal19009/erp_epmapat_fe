...
export class AddTransaciComponent implements OnInit {
   ...
   constructor(private router: Router, private fb: FormBuilder, private asiService: AsientosService,
   ...
   onSubmit() {
      ...
      let valorNumerico: number = parseFloat(this.formTransaci.get('valor')!.value);
