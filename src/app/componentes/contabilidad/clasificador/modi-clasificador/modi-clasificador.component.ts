...
constructor(public fb: FormBuilder, private clasificadorService: ClasificadorService, private router: Router,
   ) { }
...
onSubmit() {
   ...
   this.clasificadorService.updateClasificador(this.clasificadorForm.value).subscribe(datos => {
   }, error => console.log(error));
   this.retornar();
}

retornar() { this.router.navigate(['info-clasificador']) }
