...
export class ModiRetencionComponent implements OnInit {
   ...
   iAsiento = {} as NewType; //Interface para los datos del Asiento
   date: Date = new Date();
   _beneficiarios: any[] = [];
   idbene: number | null;
   _documentos: any;
      ...
      this.reteService.getById(this.idrete).subscribe({
         next: resp => {
            ...
            this.formRetencion.patchValue({
               ...
               idtabla01: retencion.idtabla01,
               intdoc: retencion.intdoc,
               ...
               valretservicios: retencion.valretservicios,
               //IVA 100%
   ...
   listarTabla01() {
      this.tabla01Service.getListaTabla01().subscribe({
         next: datos => this._tabla01 = datos,
         error: err => console.error(err.error)
      });
   }

   comparaTabla01(o1: Tabla01, o2: Tabla01): boolean {
   ...
   comparaDocumento(o1: Documentos, o2: Documentos): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
      else {
   ...
   listarTabla17() {
      this.tabla17Service.getTabla17().subscribe({
         next: datos => this._tabla17 = datos,
         error: err => console.error(err.error)
      });
   }
   comparaTabla17(o1: Tabla17, o2: Tabla17): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
      else {
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idtabla17 === o2.idtabla17;
      }
   }
   ...
   comparaTabla15(o1: Tabla15, o2: Tabla15): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
      else {
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idtabla15 === o2.idtabla15;
      }
   }
