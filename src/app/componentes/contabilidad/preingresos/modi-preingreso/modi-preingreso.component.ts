...
export class ModiPreingresoComponent implements OnInit {
   ...
   _clasificador: any;
   antcodpar: String;
   intpre: number; //Id de la Partida de Ingresos que se modifica
   filtro: string;
   ...
   ngOnInit(): void {
      ...
      this.intpre = +sessionStorage.getItem("intpreToModi")!;
   ...
   datosParingreso() {
      ...
      this.preingService.getById( this.intpre ).subscribe({
         next: datos => {
