...
export class InfoAguatramiteComponent implements OnInit {
   ...
   constructor(private getRouter: ActivatedRoute, private traminuevoService: TramiteNuevoService, private tramiaguaService: TramitesAguaService) { }
   ...
   genHojaInspeccion() {
      this.tramiaguaService.genHojaInspeccion(this.tramitenuevo.idaguatramite_aguatramite, 'Concesión de servicios');
   }
}
