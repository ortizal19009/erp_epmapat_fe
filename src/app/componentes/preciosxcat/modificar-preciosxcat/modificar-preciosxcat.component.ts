...
export class ModificarPreciosxcatComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private preciosxcatS: PreciosxcatService,
    private router: Router, private categoriaS: CategoriaService) { }
  ...
  retornarListaPrecioxCat() { this.router.navigate(['/pliego']); }
