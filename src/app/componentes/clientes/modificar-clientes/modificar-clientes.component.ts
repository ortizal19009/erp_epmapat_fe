...
export class ModificarClientesComponent implements OnInit {
   ...
   changeNacion() {
      ...
      if (cedulaControl) { cedulaControl.setValue(''); }
   }

   changeTpidentifica() {
      const cedulaControl = this.formCliente.get('cedula');
      if (cedulaControl) { cedulaControl.setValue(''); }
      this.codidentifica = this.formCliente.value.idtpidentifica_tpidentifica.codigo;
   }
   ...
   compararNacionalidad(o1: Nacionalidad, o2: Nacionalidad): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idnacionalidad == o2.idnacionalidad;
      }
   }

   compararPersoneriaJuridica(o1: PersoneriaJuridica, o2: PersoneriaJuridica): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
      else {
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idpjuridica == o2.idpjuridica;
      }
   }
   ...
   compararTpIdentifica(o1: Tpidentifica, o2: Tpidentifica): boolean {
      if (o1 === undefined && o2 === undefined) { return true; }
         ...
         return o1 === null || o2 === null || o1 === undefined || o2 === undefined ? false : o1.idtpidentifica == o2.idtpidentifica;
      }
   }
   ...
   busIdentifica(control: AbstractControl) {
      return this.cliService.valIdentificacion(control.value)
         .pipe(
            map(result => control.value != this.antcedula && result ? { existe: true } : null)
         );
   }
